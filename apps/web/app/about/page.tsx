  ...
  return (
    <article className="mx-auto max-w-[var(--measure-body)] space-y-[var(--space-6)] px-[var(--space-6)] py-[var(--space-14)]">
      ...
      <p className="text-[color:var(--color-text-muted)]">
        Scout relies on volunteered observations. Field teams may miss hazards,
        closures, or sudden construction. Always corroborate with local signage and
      ...
      >
        ...
        <p className="mt-[var(--space-3)] text-sm">
          This anchor exists for auditors linking directly to the disclaimer copy
          referenced in DEC-010 mockups (`design/screens/onboarding-modal.html`).
        </p>
      </section>
    </article>
  );
