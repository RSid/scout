  ...
  return (
    <article className="mx-auto max-w-[var(--measure-body)] space-y-[var(--space-5)] px-[var(--space-6)] py-[var(--space-14)]">
      ...
      <p className="text-[color:var(--color-text-muted)]">
        ...
        Addresses you type remain in-session unless explicitly submitted to nominatim;
        prefer the future `/api/geocode` proxy to centralize quotas.
      </p>
      <p className="text-[color:var(--color-text-muted)]">
        Location requests only fire after activating the corresponding button inside the
        planner.
      </p>
    </article>
  );
